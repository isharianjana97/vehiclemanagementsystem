        ...
        <div class="row">
            ...
            ?>
                ...
                <div>
                    ...
                    <!- display if there is a message or a empty row in the url ->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="#" class="btn btn-success" data-toggle="modal" data-target="#modalBrand">
                                <!- # can use to be on the same page ->
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <th>
                                        <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#modalBrandEdit" onclick="loadBrand('<?php echo $brand_id ?>');">
                                            <span class="glyphicon glyphicon-pencil"></span>&nbsp; Edit
                                        </a>
                                    </th>
                                </tr>
