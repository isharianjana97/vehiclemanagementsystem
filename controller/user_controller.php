        ...
        case "update_user":
           ...
           try{
                    ...
                    foreach ($user_function as $f) {
                      ...
                      <script> window.location="../view/view-users.php?msg=<?php echo $msg; ?>"</script>  <!-- Send back to view users page -->
                    <?php
               ...
               $msg=$ex->getMessage();
                    ...
                    ?>
                        <script> window.location="../view/edit-user.php?msg=<?php echo $msg; ?>"</script>  <!-- Send back to edit users page -->
                    <?php
